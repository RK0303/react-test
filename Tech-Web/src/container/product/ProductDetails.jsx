      ...
      <div>
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <button className=" w-full md:w-auto bg-zinc-200 px-8 py-3 rounded-md flex justify-center items-center gap-2 hover:bg-zinc-300 cursor-pointer" onClick={()=> dispatch(addToCart(product))}>
